	...
	return (
		<div className='relative w-full h-full'>
			<input
				...
				z-50 h-11 borderborder-white/90 rounded-md placeholder:text-sky-700
				`}
			/>
			<Search
				size={20}
				className={`absolute right-2 top-3 peer-focus:opacity-0 transition-all duration-300 ease-in-out text-sky-700
				}`}
			/>
			<Label
				{...{
